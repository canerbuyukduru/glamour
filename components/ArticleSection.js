...
const ArticleSection = () => {
  return (
    <div className="sm:px-4 py-6">
      <h2 className="text-center mb-8 text-2xl sm:text-4xl lg:text-5xl text-[#1d1d1f] font-bold leading-tight">
      ...
      <div className="flex flex-col lg:flex-row gap-8 md:gap-4">
        <div className="pt-8 md:pt-32 px-2 md:px-4 flex-1">
          <TextAnimation className={"text-[#1d1d1f] font-bold text-xl sm:text-2xl lg:text-3xl mb-4 text-center md:text-left"} text1="Küçük Bir Hayal, Büyük Bir Marka: İlk Adım Gürselpaşa" />
